...
namespace RedCounterSoftware.Common.Mailing
{
    ...
    {
        /// <summary>
        /// Sends an activation mail to the provided <see cref="IUser"/> containing the link to follow to complete the registration.
        /// </summary>
        ...
        /// <summary>
        /// Sends a password recovery mail to the provided <see cref="IUser"/> containing a link to follow to generate a new password.
        /// </summary>
        /// <param name="email">The email address of the user.</param>
